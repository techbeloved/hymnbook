...
class UpdateHymnDatabaseWithMidiFilesWorker(context: Context, params: WorkerParameters) : RxWorker(context, params) {
    override fun createWork(): Single<Result> {
        ...
        return Single.create { emitter ->
            ...
            for (fileName in directory.list { dir, name ->
                ...
                hymnId?.let { id ->
                    Injection.provideRepository.updateHymnMidiPath(id, fullMidiPath)
                    numberOfFiles++
                }
