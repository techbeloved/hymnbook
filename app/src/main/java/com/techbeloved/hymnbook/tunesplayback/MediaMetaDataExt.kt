...
inline val MediaMetadataCompat.toMediaItem: MediaBrowserCompat.MediaItem
    get() = MediaBrowserCompat.MediaItem(fullDescription, MediaBrowserCompat.MediaItem.FLAG_PLAYABLE)